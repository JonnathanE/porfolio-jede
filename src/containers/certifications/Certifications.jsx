...
import CodigoFacilito from "../../img/codigofacilito-icon.jpeg";
        ...
        <Wrapp>
          <List>
            {certifications.map((c, index) => (
              <ListItem
                key={c.id}
                hasBorder={index === certifications.length - 1 ? false : true}
              >
                <div className="flex">
                  <div>
                    {c.business === "Udemy" && (
                      <SiUdemy size={48} className="dark:text-white" />
                    )}
                    {c.business === "EDteam" && <Icon src={Edteam} />}
                    {c.business === "CódigoFacilito" && (
                      <Icon src={CodigoFacilito} />
                    )}
                  </div>
                  <div className="ml-3">
                    <div>
                      ...
                      >
                        ...
                        {c.expedition ? (
                          <SubTitle>
                            ...
                            {c.expiration ? c.expiration : "No expiration date"}
                          </SubTitle>
                        ) : null}
                    ...
                    <div className="mb-8 mt-4">
                      <BtnLink href={c.url} target="blank">
                        See credential
                      </BtnLink>
                    </div>
                  </div>
